...
// Give the path to file to add to IPFS
var path = "/home/akash/Desktop/IPFS/email.js"
...
ipfs.addFromFs(path, {recursive: true}, (err, res) => {
    ...
    Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        // Owner of the account and name of the hash you want in the account
        var owner = "A"
        var name = "abc"
